package com.github.data.imp.other.mongo.config;

import com.github.data.imp.other.mongo.config.converts.BigDecimalToDecimal128Converter;
import com.github.data.imp.other.mongo.config.converts.Decimal128ToBigDecimalConverter;
...
@Configuration
@EnableMongoAuditing
@ComponentScan("com.github.data.imp.other.mongo.helper")
